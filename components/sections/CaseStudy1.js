                        ...
                        <div className="col-lg-6 col-md-6" data-aos="zoom-in-left" data-aos-duration={1400}>
                            <div className="blog-widget-item bb-border pb-xxl-7 pb-xl-6 pb-4">
                                ...
                                <div className="blog-cont">
                                    ...
                                    <h5>
                                        <Link href="/study-details?id=1" className="white-clr d-flex align-items-center justify-content-between gap-3">
                                            Streamlined hiring and job search platform
                        ...
                        <div className="col-lg-6 col-md-6" data-aos="zoom-in-left" data-aos-duration={1600}>
                            <div className="blog-widget-item bb-border pb-xxl-7 pb-xl-6 pb-4">
                                ...
                                <div className="blog-cont">
                                    ...
                                    <h5>
                                        <Link href="/study-details?id=2" className="white-clr d-flex align-items-center justify-content-between gap-3">
                                            High-converting guest checkout system
                                            <span className="rot60">
                                                <i className="fas fa-arrow-up theme-clr" />
                                            </span>
                                        </Link>
