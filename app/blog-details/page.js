...
export default function BlogDetails() {
  ...
  // ✅ Show loading state or "not found" safely
                  ...
                  <div className="single-blog-post">
                    ...
                    <div className="post-content">
                      ...
                      <div className="row g-xl-4 g-3 mb-xxl-10 mb-xl-7 mb-lg-6 mb-4">
                        {blog.images.slice(1, 3).map((img, i) => (
                          <div
                            className="col-lg-6 col-md-6 col-sm-6"
                            data-aos="zoom-in"
                            data-aos-duration={1500 + i * 100}
                            key={i}
                          >
                            <div className="details-thumb-b1 w-100">
                              <img
                                src={img}
                                alt={`blog-img-${i + 2}`} // i + 2 to match actual image index
                                className="w-100"
                              />
                            </div>
                          </div>
