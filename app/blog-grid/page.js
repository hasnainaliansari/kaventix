...
export default function BlogGrid() {
    ...
    return (
        <>
            ...
            <Layout headerStyle={2} footerStyle={3} breadcrumbTitle="Blogs">
                            ...
                            <div className="col-lg-4 col-md-6 col-sm-6">
                                <div className="blog-widget-item">
                                    <div className="thumb w-100 overflow-hidden mb-xxl-7 mb-xl-6 mb-4">
                                        <img src="/assets/img/blog/blog-details-artificial-intelligence-guide.png" alt="img" className="w-100 overflow-hidden" />
                                    </div>
