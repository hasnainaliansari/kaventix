...
export default function Contact() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const res = await fetch("https://formspree.io/f/mwpqpvgr", {
        method: "POST",
        headers: {
            ...
            <div className="row g-xl-7 g-4 mb-xxl-7 mb-6 justify-content-center">
              ...
              >
                <div className="contact-sub-info bg1-clr text-center">
                  ...
                  <span className="msub d-block mb-2">
                    🇺🇸 USA: Sun – Thu 09:00 AM – 06:00 PM
                  </span>
                  <span className="msub">
                    🇬🇧 UK: Fri – Sat 04:00 PM – 10:00 PM
                  </span>
                </div>
              </div>
            </div>
            <div className="row g-xxl-7 g-4">
              ...
              >
                <div className="contact-map">
                  <iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1982.1736809350627!2d-0.1253655!3d51.5149327!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x487604cc4722d197%3A0xe305dcb0078d3b4e!2s71-75%20Shelton%20St%2C%20London%20WC2H%209JQ%2C%20UK!5e0!3m2!1sen!2s!4v1720852083401!5m2!1sen!2s"
                    width="100%"
                    height="450"
                    style={{ border: 0 }}
                    allowFullScreen=""
              ...
              >
                <div className="contact-content bg1-clr">
                  ...
                  <form
                    action="https://formsubmit.co/hr.kavantix@gmail.com"
                    method="POST"
                    target="_blank"
                  >
                    <div className="row g-xxl-8 g-xl-6 g-lg-4 g-4">
                      ...
                      <div className="col-lg-12">
                        <select name="subject" className="form-select" required>
                          ...
                          <option value="Graphic & Video Content">
                      ...
                      <input
                        type="hidden"
                        name="_next"
                        value="https://kaventix.vercel.app/thank-you"
                      />
